...
snackbarlayout.style = 'position: absolute; bottom: 10px; left: 2%; right: 2%; width: 96%; background-color: #00bcd4; box-shadow: 0px 0px 15px #00bcd4;border-radius: 15px;';
snackbartext.style = 'position: relative; left: 20px; color: white; width: 90%; height: 100%; display: flex; align-items: center; padding-top: 16px; padding-bottom: 16px; font-family: roboto-regular; white-space: pre-line; overflow-wrap: anywere';
...
var snackbarcolor = '#00bcd4', snackbarshadowcolor = 'rgba(0, 0, 0, 0.3)', snackbartextcolor = 'white';
...
function snackbar(txt, dur, important) {
  ...
  snackbaranim.setlisteners([function(frac, time) {
    ...
    snackbarlayout.style.boxShadow = "0px 2px ".concat(15 * (1 - frac)).concat("px " + snackbarshadowcolor);
  }]);
